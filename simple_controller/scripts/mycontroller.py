...
class Controller:
    ...
    def __init__(self) -> None:
        ...
        rospy.init_node("mycontroller" , anonymous=False)
        ...
        self.linear_speed = rospy.get_param("/mycontroller/linear_speed") # m/s
        self.angular_speed = rospy.get_param("/mycontroller/angular_speed") # rad/s
        self.goal_angle = radians(rospy.get_param("/mycontroller/goal_angle")) # rad
        self.stop_distance = rospy.get_param("/mycontroller/stop_distance") # m
        self.epsilon = rospy.get_param("/mycontroller/epsilon")
